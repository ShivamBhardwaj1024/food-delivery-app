...
async function loginUser(req,res) {
    ...
    const ispasswordMatch = await authDAO.isUserPasswordMatchDAO(req.body.password, user);
...
async function foodpartnerLogin(req,res) {
    ...
    //     email
    // })
    const foodpartnerExistance = await authDAO.isFoodPartnerExistDAO(req.body.email);
    ...
    const ismatchedpassword = await authDAO.isFoodPartnerPasswordMatchDAO(req.body.password, foodpartnerExistance);
